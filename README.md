...
## Attention: API to be SSL only on December 1, 2014

On December 1 2014 at noon EST, the Choose Digital API for both stage and production will be SSL only.

Here are the changes you need to make:

* For your stage environments, change "http://api-stage.choosedigital.cloudbees.net" to "https://api-stage.choosedigital.com"
* For your production environment, change "http://api-prod.choosedigital.cloudbees.net" to "https://api.choosedigital.com"
